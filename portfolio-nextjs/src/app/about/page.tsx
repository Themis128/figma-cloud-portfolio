...
export const metadata: Metadata = {
  title: "About Me",
  description: "Learn about Themistoklis Baltzakis - Cloud Architect & Cybersecurity Specialist with 15+ years of IT expertise in Azure AD, Microsoft 365, and multi-cloud environments.",
};
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10 hover:border-cyan-400/30 transition-all duration-300">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={skill} className="flex items-center gap-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10 hover:border-cyan-400/30 transition-all duration-300">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={cert} className="flex items-center gap-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                        <div className="w-2 h-2 bg-cyan-400 rounded-full flex-shrink-0" />
