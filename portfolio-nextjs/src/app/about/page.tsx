            ...
            <AnimatedSection delay={0.1}>
              <div className='bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10'>
                ...
                <div className='text-white/80 space-y-4 leading-relaxed'>
                  ...
                  <p>
                    Beyond technical expertise, I&apos;m passionate about technology as a catalyst
                    for positive change. During COVID-19, I supported vulnerable communities through
                    telecommunications services, then contributed to Athens International
                    Airport&apos;s critical infrastructure rebuild—enabling safe travel and economic
                    recovery. Currently completing my Master&apos;s research in data-driven
                    agricultural innovations, I&apos;m exploring how smart technology can empower
                    sustainable farming and rural communities.
                  </p>
                </div>
              </div>
            </AnimatedSection>
