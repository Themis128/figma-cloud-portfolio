...
export const metadata: Metadata = {
  ...
  description: "Full-stack developer specializing in React, Next.js, AWS, and cloud solutions. Building modern, scalable web applications with cutting-edge technologies.",
};
