  ...
  app.use((_req, res, next) => {
    ...
    res.setHeader(
      ...
      "default-src 'self'; " +
        ...
        "connect-src 'self' https://api.github.com https://www.google-analytics.com https://region1.google-analytics.com https://www.recaptcha.net https://www.gstatic.com https://storage.googleapis.com wss://localhost:* ws://localhost:*; " +
