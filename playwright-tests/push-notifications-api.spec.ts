...
test.describe('Push Notifications API', () => {
  ...
  test.describe('GET /api/push-notifications', () => {
    ...
    test('should send test notifications to all subscriptions', async ({ request }) => {
      ...
      const response = await request.get('http://localhost:3002/api/push-notifications')
    ...
    test('should return error when no subscriptions exist for test', async ({ request }) => {
  ...
  test.describe('POST /api/push-notifications', () => {
    test('should send push notification to specific subscriptions', async ({ request }) => {
      const testMessage = {
      ...
      const response = await request.post('http://localhost:3002/api/push-notifications', {
        data: {
          subscriptions,
          message: testMessage,
        },
  ...
  test.describe('PUT /api/push-notifications', () => {
    test('should store push subscription', async ({ request }) => {
      ...
      const response = await request.put('http://localhost:3002/api/push-notifications', {
        data: subscription,
      })
    ...
    test('should return error for invalid subscription data', async ({ request }) => {
    ...
    test('should update existing subscription with same endpoint', async ({ request }) => {
      const subscription1 = {
        endpoint: 'https://fcm.googleapis.com/fcm/send/test-endpoint',
        keys: {
          p256dh: 'test-p256dh-key-1',
  ...
  test.describe('DELETE /api/push-notifications', () => {
    ...
    test('should return error for missing endpoint parameter', async ({ request }) => {
      const response = await request.delete('http://localhost:3002/api/push-notifications')
  ...
  test.describe('Security & Validation', () => {
    ...
    test('should handle XSS prevention in message content', async ({ request }) => {
  ...
  test.describe('Integration with Client Features', () => {
    test('should work with service worker registration', async ({ page, request }) => {
