...
test.describe('Deep Linking — Direct URL Access', () => {
  for (const route of ALL_ROUTES) {
    test(`navigating directly to ${route.path} renders content`, async ({ page }) => {
...
test.describe('SPA Navigation — Link Component (No Full Page Reload)', () => {
  ...
  test('clicking a nav link updates the URL without reload', async ({ page }) => {
    await page.goto('/')
    await page.waitForLoadState('networkidle')
  ...
  test('clicking nav links to /product updates URL correctly', async ({ page }) => {
    await page.goto('/')
    await page.waitForLoadState('networkidle')
