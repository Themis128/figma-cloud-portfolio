...
test.describe("Modern Web APIs", () => {
  test.describe("Intersection Observer", () => {
    test(
      "should support Intersection Observer API",
      { tag: "@fast" },
      async ({ page }) => {
        await page.goto("/");
    ...
    test("should handle lazy loading with Intersection Observer", async ({
      page,
    }) => {
      await page.goto("/");
  ...
  test.describe("Web Animations API", () => {
    test(
      "should support Web Animations API",
      { tag: "@fast" },
      async ({ page }) => {
        await page.goto("/");
  ...
  test.describe("Storage APIs", () => {
    test(
      "should support localStorage and sessionStorage",
      { tag: "@fast" },
      async ({ page }) => {
        await page.goto("/");
