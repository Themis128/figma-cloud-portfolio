...
test.describe("reCAPTCHA and Google Analytics API Integration Tests", () => {
  test.describe("Contact Form API with reCAPTCHA", () => {
    test("should accept valid contact form submission with reCAPTCHA token", async ({
      ...
      try {
        ...
        if (
          ...
          console.log(
            "API server not available, skipping contact form API test",
          );
          test.skip();
        } else {
    ...
    test("should reject contact form submission without reCAPTCHA token", async ({
      request,
    }) => {
      try {
        const response = await request.post(
    ...
    test("should reject contact form submission with invalid email", async ({
      request,
    }) => {
      try {
        const response = await request.post(
  ...
  test.describe("Google Analytics Integration Verification", () => {
    ...
    test("should maintain functionality when GA is blocked", async ({
      page,
    }) => {
      // Block GA scripts
      await page.route("**/googletagmanager.com/**", (route) => route.abort());
  ...
  test.describe("Combined Integration Tests", () => {
    test("should handle both services being unavailable gracefully", async ({
      page,
    }) => {
    ...
    test("should handle page navigation without external services", async ({
      page,
    }) => {
  ...
  test.describe("Environment Configuration Tests", () => {
    ...
    test("should handle API endpoint availability", async ({ request }) => {
      try {
        ...
        // Skip test if API server is not available
        console.log(
          "API server not available, skipping endpoint availability test",
        );
        test.skip();
      }
    });
  ...
  test.describe("Performance and Reliability Tests", () => {
    ...
    test("should handle multiple API calls", async ({ request }) => {
      try {
        ...
        // Skip test if API server is not available
        console.log(
          "API server not available, skipping multiple API calls test",
        );
        test.skip();
      }
    });
