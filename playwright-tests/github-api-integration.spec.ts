...
test.describe("GitHub API Integration", () => {
  ...
  test.describe("Deployment Monitoring", () => {
    test("should display deployment status", async ({ page }) => {
      ...
      const deploymentMonitor = page.locator(
        '[data-testid="deployment-monitor"]',
      );
      ...
      if (exists) {
        ...
        console.log(
          "Deployment monitor not found on page - may not be implemented yet",
        );
      }
    });
