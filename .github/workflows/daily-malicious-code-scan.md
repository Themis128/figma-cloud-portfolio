...
on:
  schedule: weekly on Wednesday around 3 AM UTC
  workflow_dispatch:
permissions:
  contents: read
  actions: read
...
timeout-minutes: 15
strict: true
source: githubnext/agentics/workflows/daily-malicious-code-scan.md@ec7d342403c9912c87320110f8822a8fbb817a0c
engine: copilot
---
