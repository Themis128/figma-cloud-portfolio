    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      >
        ...
        <g opacity="0.2">
          ...
          <rect x="100" y="150" width="30" height="30" fill="none" stroke="#00d4ff" strokeWidth="1" />
          <rect x="200" y="250" width="40" height="40" fill="none" stroke="#00d4ff" strokeWidth="1" />
          <rect x="120" y="400" width="25" height="25" fill="none" stroke="#00d4ff" strokeWidth="1" />
          <rect x="850" y="100" width="35" height="35" fill="none" stroke="#00d4ff" strokeWidth="1" />
          <rect x="900" cy="400" width="30" height="30" fill="none" stroke="#00d4ff" strokeWidth="1" />
        </g>
      ...
      <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-gradient-to-br from-cyan-500/10 to-transparent blur-3xl animate-pulse" style={{ animationDuration: "4s" }} />
      <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-gradient-to-tr from-blue-500/10 to-transparent blur-3xl animate-pulse" style={{ animationDuration: "5s", animationDelay: "1s" }} />
    </div>
  );
}
