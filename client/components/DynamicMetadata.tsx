...
const DynamicMetadata: React.FC<DynamicMetadataProps> = ({ config }) => {
  ...
  useEffect(() => {
    ...
    // Default values
    const defaultTitle = "Themistoklis Baltzakis - Cloud Architect & Cybersecurity Specialist";
    ...
    const removeExistingMetaTags = () => {
      const metaTags = document.querySelectorAll("meta[name], meta[property], meta[itemprop]");
    ...
    createMetaTag("og:site_name", "Themistoklis Baltzakis Portfolio", "og:site_name");
    ...
    const schemaData = {
      ...
      ...(type === "website" && {
        sameAs: ["https://www.linkedin.com/in/baltzakis-themis", "https://www.baltzakisthemis.com"],
      }),
    ...
    createMetaTag("og:updated_time", new Date().toISOString(), "og:updated_time");
    createMetaTag("article:published_time", publishedAt, "article:published_time");
  ...
  }, [location.pathname, config, location.search]);
...
export const metadataConfigs = {
  home: {
    title: "Themistoklis Baltzakis - Cloud Architect & Cybersecurity Specialist",
    description:
      "Technical Leadership and Cloud Innovation with 15+ years of IT expertise, specializing in Azure AD, Microsoft 365, and multi-cloud environments.",
    keywords: [
      "Cloud Architecture",
    ...
    tags: ["Cloud", "Security", "Architecture", "DevOps", "Azure", "Microsoft 365"],
  },
  ...
  about: {
    ...
    keywords: ["About", "Experience", "Background", "Cloud Expert", "Security Specialist"],
  ...
  projects: {
    ...
    keywords: ["Projects", "Portfolio", "Cloud Projects", "Security Projects", "Web Development"],
    type: "website" as const,
    author: "Themistoklis Baltzakis",
