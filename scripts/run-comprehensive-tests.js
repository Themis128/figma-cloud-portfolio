...
for (const testConfig of testConfigs) {
  ...
  try {
    execSync(`npx playwright test ${testConfig.config} --config=playwright-tests/comprehensive-tests.config.ts`, {
      stdio: 'inherit',
      cwd: PROJECT_ROOT,
...
try {
  execSync('npx playwright test playwright-tests/ --config=playwright-tests/comprehensive-tests.config.ts', {
    stdio: 'inherit',
    cwd: PROJECT_ROOT,
    env: { ...process.env, CI: 'true' }
  })
