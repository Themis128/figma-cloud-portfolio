...
/**
 * Simple Test Dashboard Launcher
 * Starts the progress server, opens the dashboard, and runs Playwright tests
 */
class SimpleTestDashboardLauncher {
...
// Start the dashboard
const launcher = new SimpleTestDashboardLauncher();
