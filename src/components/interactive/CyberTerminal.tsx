  ...
  switch (trimmed) {
    ...
    case 'whoami':
      return [
        ...
        { text: '  ║  Cloud Architect & Cybersecurity      ║', type: 'ascii' },
        { text: '  ║  Specialist                           ║', type: 'ascii' },
        { text: '  ║                                       ║', type: 'ascii' },
        { text: '  ║  Location : Athens, Greece            ║', type: 'ascii' },
        { text: '  ║  Focus    : AWS · Security · DevOps   ║', type: 'ascii' },
        { text: '  ╚══════════════════════════════════════╝', type: 'ascii' },
        { text: '', type: 'response' },
      ];
    ...
    case 'experience':
      return [
        ...
        { text: '', type: 'response' },
        { text: '  Cloud Architect & Cybersecurity Specialist', type: 'response' },
