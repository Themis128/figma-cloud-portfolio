...
export function WorkflowBuilder({
  ...
  return (
    <div className="relative w-full h-96 bg-foreground/5 rounded-lg border border-border overflow-hidden">
      <svg
        ref={svgRef}
      ...
      {/* Node info panel */}
      {selectedNode && (
        <div className="absolute top-4 right-4 bg-foreground/10 backdrop-blur-sm rounded-lg p-4 border border-border max-w-xs">
          <h4 className="text-foreground font-semibold mb-2">Node Details</h4>
          {(() => {
            ...
            return (
              <div className="space-y-2 text-sm">
                ...
                {Object.keys(node.config).length > 0 && (
                  <div>
                    <p className="text-muted-foreground mb-1">Config:</p>
                    <pre className="text-xs bg-foreground/5 p-2 rounded text-foreground/80 overflow-x-auto">
