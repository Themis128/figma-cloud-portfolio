    ...
    <div className="w-full max-w-2xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">
          Build your own AI agent template from scratch
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              className="bg-foreground/5 border-border text-foreground placeholder:text-muted-foreground min-h-25"
              required
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-foreground/5 border border-border rounded-lg text-foreground focus:outline-none focus:border-cyan-400/50"
              >
          ...
          <div className="flex flex-wrap gap-2">
            {template.tags.map((tag) => (
              <Badge
                key={tag}
                variant="secondary"
                className="bg-foreground/10 text-foreground/80 border-border flex items-center gap-1"
              >
                {tag}
                <button
                  type="button"
            ...
            {template.features.map((feature) => (
              ...
              >
                ...
                <button
                  ...
                  className="ml-auto text-muted-foreground/70 hover:text-muted-foreground"
                >
                  <X className="w-4 h-4" />
                </button>
              </li>
        ...
        <div className="flex gap-4 pt-6">
          <Button
            ...
            onClick={onCancel}
            variant="outline"
            className="flex-1 border-border text-muted-foreground hover:bg-foreground/10"
          >
            Cancel
          </Button>
          <Button
