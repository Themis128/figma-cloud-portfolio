    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Building your AI agent</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-foreground/5 backdrop-blur-sm rounded-xl border border-border p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  className="bg-foreground/10 border-border text-foreground"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-foreground/10 border border-border rounded-lg text-foreground focus:outline-none focus:border-cyan-400"
                >
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                ...
                <Badge variant="secondary">
                  {agent.workflow.connections.length}
                </Badge>
              </div>
              <div className="flex justify-between items-center">
