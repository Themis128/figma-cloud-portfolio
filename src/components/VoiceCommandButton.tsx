            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                {confidence > 0 && (
                  <Badge variant="outline">
                    {Math.round(confidence * CONFIDENCE_PERCENTAGE_MULTIPLIER)}%
                    confidence
                  </Badge>
                )}
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="max-h-40 overflow-y-auto space-y-1">
                  {availableCommands
                    .slice(0, MAX_DISPLAYED_COMMANDS)
                    .map((command) => (
                      <div
                        key={command.keywords[0]}
                  ...
                  {availableCommands.length > MAX_DISPLAYED_COMMANDS && (
                    <p className="text-xs text-muted-foreground">
                      ... and{" "}
                      {availableCommands.length - MAX_DISPLAYED_COMMANDS} more
                    </p>
                  )}
                </div>
              </div>
