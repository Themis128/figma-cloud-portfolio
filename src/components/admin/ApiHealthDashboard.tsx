...
const ENDPOINTS: EndpointDef[] = [
...

  {
    ...
    service: "GitHub API",
    description: "Public profile statistics (repos, stars, followers)",
    healthCheck: { method: "GET", path: "/api/github/stats" },
  },
  {
    id: "github-repos",
    name: "GitHub Repos",
    ...
    service: "GitHub API",
    description: "Public repositories with languages and topics",
    healthCheck: { method: "GET", path: "/api/github/repos?limit=1" },
  },
  {
    id: "search",
    name: "Search",
    ...
    path: "/api/search",
    service: "Lambda",
    description: "Portfolio content search",
    healthCheck: { method: "GET", path: "/api/search?q=cloud" },
  },
  {
    id: "monitor",
    name: "Monitor",
    ...
    path: "/api/monitor",
    service: "Lambda",
    description: "Server monitoring (requests, memory, uptime)",
    healthCheck: { method: "GET", path: "/api/monitor" },
  },
  {
    id: "resume-generate",
    name: "Resume Data",
    ...
    service: "Lambda",
    description: "Resume data as JSON with PDF link",
    healthCheck: { method: "GET", path: "/api/resume/generate" },
  },
  {
    id: "webhook",
    name: "Webhook",
    ...
    path: "/api/webhook",
    service: "Lambda",
    description: "Generic webhook receiver for integrations",
    healthCheck: {
      method: "POST",
      path: "/api/webhook",
  ...
  },
  {
    ...
    path: "/api/docs",
    service: "Lambda",
    description: "API endpoint documentation (JSON)",
    healthCheck: { method: "GET", path: "/api/docs" },
  },
];
