...
export function ManageCookiesButton() {
  ...
  return (
    <button
      ...
      className="font-mono text-xs text-muted-foreground underline underline-offset-2 transition-colors hover:text-cyan-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-400"
    >
      Manage Cookies
    </button>
  );
