          ...
          <AnimatedSection className="max-w-4xl mx-auto text-center space-y-6 mb-16 md:mb-24">
            ...
            <AnimatedSection delay={0.2}>
              <p className="text-cyan-400 text-lg sm:text-xl font-semibold tracking-wide">
                Beat ATS Systems & Land IT Interviews
              </p>
              <p className="text-muted-foreground text-base sm:text-lg leading-relaxed max-w-3xl mx-auto">
                75% of resumes are rejected by Applicant Tracking Systems before
                a human ever sees them. This guide covers how ATS works, what
                makes a strong IT resume, and the mistakes that get you
                filtered out.
              </p>
            </AnimatedSection>
          </AnimatedSection>
